  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-semibold text-gray-800 mx-auto",
        nav: "flex items-center gap-1",
        button_previous: cn(
          buttonVariants({ variant: "ghost" }),
          "h-7 w-7 p-0 text-gray-500 hover:text-indigo-600 hover:bg-indigo-50"
        ),
        button_next: cn(
          buttonVariants({ variant: "ghost" }),
          "h-7 w-7 p-0 text-gray-500 hover:text-indigo-600 hover:bg-indigo-50"
        ...
        today: "border border-indigo-400 text-indigo-600 font-semibold rounded-md",
        outside:
